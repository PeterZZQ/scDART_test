...
np.save(file = "../test/results_snare/z_rna_" + str(latent_dim) + "_" + str(reg_d) + "_" + str(reg_g) + "_" + str(reg_mmd) + "_" + str(seed) + "_l1_quant.npy", arr = z_rna.numpy())
np.save(file = "../test/results_snare/z_atac_" + str(latent_dim) + "_" + str(reg_d) + "_" + str(reg_g) + "_" + str(reg_mmd) + "_" + str(seed) + "_l1_quant.npy", arr = z_atac.numpy())
torch.save(model_dict, "../test/results_snare/model_" + str(latent_dim) + "_" + str(reg_d) + "_" + str(reg_g) + "_" + str(reg_mmd) + "_" + str(seed) + "_l1_quant.pth")
